...
public class Constants {
    public static final String AAMOwnerUsername = "AAMOwner";
    public static final String AAMOwnerPassword = "AAMPassword";

    public static final String platformOwnerUsername = "testPOusername";
    public static final String platformOwnerPassword = "testPOpassword";
    public static final String federatedId = "testFederatedId";
    public static final String recoveryMail = "null@dev.null";

    public static final String platformOwnerUsername2 = "testPOusername2";
    public static final String platformOwnerPassword2 = "testPOpassword2";
